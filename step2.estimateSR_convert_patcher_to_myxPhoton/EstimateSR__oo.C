...
#define fIDX_LXPLUS_QCDMadgraph100   6
#define fIDX_LXPLUS_QCDMadgraph200   7
#define fIDX_LXPLUS_QCDMadgraph400   8
#define fIDX_LXPLUS_QCDMadgraph70    9
#define fIDX_LXPLUS_DataE           10
#define fIDX_LXPLUS_DataF           11
#define fIDX_LXPLUS_DataG           12
...
//Getting the CDFs for Shower shape corrections
   ...
   std::cout << "file name " << fileName << " is DataE? " << (fileName=="DataE") << std::endl;

  const std::vector<std::string> lxplus_files({
"/afs/cern.ch/user/l/ltsai/eos_storage/condor_summary/2022EE_GJet/G4JetsMadgraph_100to200.root",
"/afs/cern.ch/user/l/ltsai/eos_storage/condor_summary/2022EE_GJet/G4JetsMadgraph_200to400.root",
"/afs/cern.ch/user/l/ltsai/eos_storage/condor_summary/2022EE_GJet/G4JetsMadgraph_400to600.root",
"/afs/cern.ch/user/l/ltsai/eos_storage/condor_summary/2022EE_GJet/G4JetsMadgraph_40to70.root",
"/afs/cern.ch/user/l/ltsai/eos_storage/condor_summary/2022EE_GJet/G4JetsMadgraph_600toinf.root",
"/afs/cern.ch/user/l/ltsai/eos_storage/condor_summary/2022EE_GJet/G4JetsMadgraph_70to100.root",
"/afs/cern.ch/user/l/ltsai/eos_storage/condor_summary/2022EE_GJet/QCD4JetsMadgraph_100to200.root",
"/afs/cern.ch/user/l/ltsai/eos_storage/condor_summary/2022EE_GJet/QCD4JetsMadgraph_200to400.root",
"/afs/cern.ch/user/l/ltsai/eos_storage/condor_summary/2022EE_GJet/QCD4JetsMadgraph_400to600.root",
"/afs/cern.ch/user/l/ltsai/eos_storage/condor_summary/2022EE_GJet/QCD4JetsMadgraph_70to100.root",
"/afs/cern.ch/user/l/ltsai/eos_storage/condor_summary/2022EE_GJet/Run2022E.root",
"/afs/cern.ch/user/l/ltsai/eos_storage/condor_summary/2022EE_GJet/Run2022F.root",
"/afs/cern.ch/user/l/ltsai/eos_storage/condor_summary/2022EE_GJet/Run2022G.root",
});
if(fileName=="DataE"){
    tr->Add( lxplus_files[fIDX_LXPLUS_DataE].c_str() );
  ...
  jec_sf_L23 = cset_jet_jerc_file->at("Summer22EE_22Sep2023_RunE_V2_DATA_L2L3Residual_AK4PFPuppi");
    ...
    tr->Add( lxplus_files[fIDX_LXPLUS_DataF].c_str() );
  ...
  jec_sf_L23 = cset_jet_jerc_file->at("Summer22EE_22Sep2023_RunF_V2_DATA_L2L3Residual_AK4PFPuppi");
    ...
    tr->Add( lxplus_files[fIDX_LXPLUS_DataG].c_str() );
...
//Booking Histograms for Pt and Correlation matrix
  ...
  jetPt = SelJet[0].Pt();
  jetEta = SelJet[0].Eta();
  genPhotonPt = isData ? -1 : GenPhoton[0].Pt();
  genPhotonEta = isData ? -1 : GenPhoton[0].Eta();
  genPhotonPhi = isData ? -1 : GenPhoton[0].Phi();
  //tree->Fill();
