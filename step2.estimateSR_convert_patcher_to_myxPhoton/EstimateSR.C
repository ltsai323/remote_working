...
int main(int argc, char** argv){
  ...
  if(fileName=="DataE"){
    //tr->Add("/eos/home-l/ltsai//public/Run2022E.root"); // lxplus
    ...
    //tr->Add("/eos/home-l/ltsai//public/Run2022F.root"); // lxplus
    ...
    //tr->Add("/eos/home-l/ltsai//public/Run2022G.root");// lxplus
  ...
  //tr->Add("/eos/home-l/ltsai//public/GJetPythia_40_MGG80.root");
    ...
    //const char* inFILE = "/eos/home-l/ltsai//public/G4JetsMadgraph_40to70.root"; // lxplus
    const char* inFILE = "/data4/ltsai/ReceivedFile/2022EE_NanoAODv12/G4JetsMadgraph_40to70.root"; // chip
    tr->Add(inFILE);
    ...
    //const char* inFILE = "/eos/home-l/ltsai//public/G4JetsMadgraph_70to100.root"; // lxplus
    const char* inFILE = "/data4/ltsai/ReceivedFile/2022EE_NanoAODv12/G4JetsMadgraph_70to100.root"; // chip
    tr->Add(inFILE);
    double totGenW = TotalGenWeight(inFILE);
    ...
    //const char* inFILE = "/eos/home-l/ltsai//public/G4JetsMadgraph_100to200.root"; // lxplus
    const char* inFILE = "/data4/ltsai/ReceivedFile/2022EE_NanoAODv12/G4JetsMadgraph_100to200.root"; // chip
    tr->Add(inFILE);
    double totGenW = TotalGenWeight(inFILE);
    ...
    //const char* inFILE = "/eos/home-l/ltsai//public/G4JetsMadgraph_200to400.root"; // lxplus
    const char* inFILE = "/data4/ltsai/ReceivedFile/2022EE_NanoAODv12/G4JetsMadgraph_200to400.root"; // chip
    tr->Add(inFILE);
    double totGenW = TotalGenWeight(inFILE);
    ...
    //const char* inFILE = "/eos/home-l/ltsai//public/G4JetsMadgraph_400to600.root"; // lxplus
    const char* inFILE = "/data4/ltsai/ReceivedFile/2022EE_NanoAODv12/G4JetsMadgraph_400to600.root"; // chip
    tr->Add(inFILE);
    double totGenW = TotalGenWeight(inFILE);
    ...
    //const char* inFILE = "/eos/home-l/ltsai//public/G4JetsMadgraph_600toinf.root"; // lxplus
    const char* inFILE = "/data4/ltsai/ReceivedFile/2022EE_NanoAODv12/G4JetsMadgraph_600toinf.root"; // chip
    tr->Add(inFILE);
    double totGenW = TotalGenWeight(inFILE);
    ...
    //const char* inFILE = "/eos/home-l/ltsai//public/QCD4JetsMadgraph_70to100.root"; // lxplus
    const char* inFILE = "/data4/ltsai/ReceivedFile/2022EE_NanoAODv12/QCD4JetsMadgraph_70to100.root"; // chip
    tr->Add(inFILE);
    double totGenW = TotalGenWeight(inFILE);
    ...
    //const char* inFILE = "/eos/home-l/ltsai//public/QCD4JetsMadgraph_100to200.root"; // lxplus
    const char* inFILE = "/data4/ltsai/ReceivedFile/2022EE_NanoAODv12/QCD4JetsMadgraph_100to200.root"; // chip
    tr->Add(inFILE);
    double totGenW = TotalGenWeight(inFILE);
    ...
    //const char* inFILE = "/eos/home-l/ltsai//public/QCD4JetsMadgraph_200to400.root"; // lxplus
    const char* inFILE = "/data4/ltsai/ReceivedFile/2022EE_NanoAODv12/QCD4JetsMadgraph_200to400.root"; // chip
    tr->Add(inFILE);
    double totGenW = TotalGenWeight(inFILE);
    ...
    //const char* inFILE = "/eos/home-l/ltsai//public/QCD4JetsMadgraph_400to600.root"; // lxplus
    const char* inFILE = "/data4/ltsai/ReceivedFile/2022EE_NanoAODv12/QCD4JetsMadgraph_400to600.root"; // chip
    tr->Add(inFILE);
    double totGenW = TotalGenWeight(inFILE);
    ...
    //const char* inFILE = "/eos/home-l/ltsai//public/QCD4JetsMadgraph_600to800.root"; // lxplus
    const char* inFILE = "/data4/ltsai/ReceivedFile/2022EE_NanoAODv12/QCD4JetsMadgraph_600to800.root"; // chip
    tr->Add(inFILE);
    double totGenW = TotalGenWeight(inFILE);
    ...
    //const char* inFILE = "/eos/home-l/ltsai//public/QCD4JetsMadgraph_800to1000.root"; // lxplus
    const char* inFILE = "/data4/ltsai/ReceivedFile/2022EE_NanoAODv12/QCD4JetsMadgraph_800to1200.root"; // chip
    tr->Add(inFILE);
    double totGenW = TotalGenWeight(inFILE);
    ...
    //const char* inFILE = "/eos/home-l/ltsai//public/QCD4JetsMadgraph_1000to1200.root"; // lxlus
    const char* inFILE = "/data4/ltsai/ReceivedFile/2022EE_NanoAODv12/QCD4JetsMadgraph_1000to1200.root"; // chip
    tr->Add(inFILE);
    double totGenW = TotalGenWeight(inFILE);
    ...
    //const char* inFILE = "/eos/home-l/ltsai//public/QCD5JetsMadgraph_1200to1500.root"; // lxplus
    const char* inFILE = "/data4/ltsai/ReceivedFile/2022EE_NanoAODv12/QCD4JetsMadgraph_1200to1500.root"; // chip
    tr->Add(inFILE);
    double totGenW = TotalGenWeight(inFILE);
    ...
    //const char* inFILE = "/eos/home-l/ltsai//public/QCD4JetsMadgraph_1500to2000.root"; // lxplus
    const char* inFILE = "/data4/ltsai/ReceivedFile/2022EE_NanoAODv12/QCD4JetsMadgraph_1500to2000.root"; // chip
    tr->Add(inFILE);
    double totGenW = TotalGenWeight(inFILE);
    ...
    //const char* inFILE = "/eos/home-l/ltsai//public/QCD4JetsMadgraph_2000toinf.root"; // lxplus
    const char* inFILE = "/data4/ltsai/ReceivedFile/2022EE_NanoAODv12/QCD4JetsMadgraph_2000toinf.root"; // chip
    tr->Add(inFILE);
    double totGenW = TotalGenWeight(inFILE);
    ...
    //tr->Add("/afs/cern.ch/user/l/ltsai/eos_storage/condor_storage/G4JetsMadgraph_600toinf/outFile_G4JetsMadgraph_600toinf_0.root"); // lxplus
    ...
    //tr->Add("/afs/cern.ch/user/l/ltsai/eos_storage/condor_storage/Run2022E/outFile_Run2022E_0.root"); // lxplus
    tr->Add("/data4/ltsai/ReceivedFile/2022EE_NanoAODv12/Run2022E.root"); // chip
...
#define MAX_GENJET 80
  ...
  for(iEvent = 0; iEvent< nEntries; ++iEvent){
    ...
    for(int ij=0; ij<nJet; ++ij){
      ...
      if ( int(Jet_jetId[ij])!=6 ) continue;
