...
# Access the 'expdata' directory
    ...
    var_looping_info = [
            ...
            { 'var': 'bALL_Pho_pt',          'xLABEL': 'Photon $p_T$ [GeV]'         , 'figNAME': 'hB_pPt.pdf'         ,'ySCALE': 'log'   },
            #{ 'var': 'b_PNetB',           'xLABEL':'B Score (ParticleNet)'       , 'figNAME': 'hTagB_PNetB.pdf'    ,'ySCALE': 'log'   },
            #{ 'var': 'b_PNetCvsB',        'xLABEL':'CvsB Score (ParticleNet)'    , 'figNAME': 'hTagB_PNetCvB.pdf'  ,'ySCALE': 'log'   },
            #{ 'var': 'b_PNetCvsL',        'xLABEL':'CvsL Score (ParticleNet)'    , 'figNAME': 'hTagB_PNetCvL.pdf'  ,'ySCALE': 'log'   },
            #{ 'var': 'b_PNetQvsG',        'xLABEL':'QvsG Score (ParticleNet)'    , 'figNAME': 'hTagB_PNetQvG.pdf'  ,'ySCALE': 'log'   },
            #{ 'var': 'b_ParTB',           'xLABEL':'B Score (ParTransformer)'    , 'figNAME': 'hTagB_ParTB.pdf'    ,'ySCALE': 'log'   },
            #{ 'var': 'b_ParTCvsB',        'xLABEL':'CvsB Score (ParTransformer)' , 'figNAME': 'hTagB_ParTCvB.pdf'  ,'ySCALE': 'log'   },
            #{ 'var': 'b_ParTCvsL',        'xLABEL':'CvsL Score (ParTransformer)' , 'figNAME': 'hTagB_ParTCvL.pdf'  ,'ySCALE': 'log'   },
            #{ 'var': 'b_ParTQvsG',        'xLABEL':'QvsG Score (ParTransformer)' , 'figNAME': 'hTagB_ParTQvG.pdf'  ,'ySCALE': 'log'   },
            #{ 'var': 'b_DeepFlavourB',    'xLABEL':'B Score (DeepFlavour)'       , 'figNAME': 'hTagB_DJetB.pdf'    ,'ySCALE': 'log'   },
            #{ 'var': 'b_DeepFlavourCvsB', 'xLABEL':'CvsB Score (DeepFlavour)'    , 'figNAME': 'hTagB_DJetCvB.pdf'  ,'ySCALE': 'log'   },
            #{ 'var': 'b_DeepFlavourCvsL', 'xLABEL':'CvsL Score (DeepFlavour)'    , 'figNAME': 'hTagB_DJetCvL.pdf'  ,'ySCALE': 'log'   },
            #{ 'var': 'b_DeepFlavourQvsG', 'xLABEL':'QvsG Score (DeepFlavour)'    , 'figNAME': 'hTagB_DJetQvG.pdf'  ,'ySCALE': 'log'   },
            { 'var': 'bALL_PhoEta',          'xLABEL': 'Photon $\eta$'              , 'figNAME': 'hB_pEta.pdf'        ,'ySCALE': 'log'   },
            { 'var': 'bALL_PhoPhi',          'xLABEL': 'Photon $\phi$'              , 'figNAME': 'hB_pPhi.pdf'        ,'ySCALE': 'log'   },
            ...
            { 'var': 'eALL_Pho_pt',          'xLABEL': 'Gamma $p_T$ [GeV]'          , 'figNAME': 'hE_pPt.pdf'         ,'ySCALE': 'log'   },
            #{ 'var': 'e_PNetB',           'xLABEL':'B Score (ParticleNet)'       , 'figNAME': 'hTagE_PNetB.pdf'    ,'ySCALE': 'log'   },
            #{ 'var': 'e_PNetCvsB',        'xLABEL':'CvsB Score (ParticleNet)'    , 'figNAME': 'hTagE_PNetCvB.pdf'  ,'ySCALE': 'log'   },
            #{ 'var': 'e_PNetCvsL',        'xLABEL':'CvsL Score (ParticleNet)'    , 'figNAME': 'hTagE_PNetCvL.pdf'  ,'ySCALE': 'log'   },
            #{ 'var': 'e_PNetQvsG',        'xLABEL':'QvsG Score (ParticleNet)'    , 'figNAME': 'hTagE_PNetQvG.pdf'  ,'ySCALE': 'log'   },
            #{ 'var': 'e_ParTB',           'xLABEL':'B Score (ParTransformer)'    , 'figNAME': 'hTagE_ParTB.pdf'    ,'ySCALE': 'log'   },
            #{ 'var': 'e_ParTCvsB',        'xLABEL':'CvsB Score (ParTransformer)' , 'figNAME': 'hTagE_ParTCvB.pdf'  ,'ySCALE': 'log'   },
            #{ 'var': 'e_ParTCvsL',        'xLABEL':'CvsL Score (ParTransformer)' , 'figNAME': 'hTagE_ParTCvL.pdf'  ,'ySCALE': 'log'   },
            #{ 'var': 'e_ParTQvsG',        'xLABEL':'QvsG Score (ParTransformer)' , 'figNAME': 'hTagE_ParTQvG.pdf'  ,'ySCALE': 'log'   },
            #{ 'var': 'e_DeepFlavourB',    'xLABEL':'B Score (DeepFlavour)'       , 'figNAME': 'hTagE_DJetB.pdf'    ,'ySCALE': 'log'   },
            #{ 'var': 'e_DeepFlavourCvsB', 'xLABEL':'CvsB Score (DeepFlavour)'    , 'figNAME': 'hTagE_DJetCvB.pdf'  ,'ySCALE': 'log'   },
            #{ 'var': 'e_DeepFlavourCvsL', 'xLABEL':'CvsL Score (DeepFlavour)'    , 'figNAME': 'hTagE_DJetCvL.pdf'  ,'ySCALE': 'log'   },
            #{ 'var': 'e_DeepFlavourQvsG', 'xLABEL':'QvsG Score (DeepFlavour)'    , 'figNAME': 'hTagE_DJetQvG.pdf'  ,'ySCALE': 'log'   },
            { 'var': 'eALL_PhoEta',          'xLABEL': 'Photon $\eta$'              , 'figNAME': 'hE_pEta.pdf'        ,'ySCALE': 'log'   },
            { 'var': 'eALL_PhoPhi',          'xLABEL': 'Photon $\phi$'              , 'figNAME': 'hE_pPhi.pdf'        ,'ySCALE': 'log'   },
