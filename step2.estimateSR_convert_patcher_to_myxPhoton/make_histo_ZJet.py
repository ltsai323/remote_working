...
if __name__ == "__main__":
    inFILE = '/Users/noises/Downloads/outFile_ZJetMC_DYto2L2Jets_MLL50_PTLL200to400_1J_2.root'
    df = ROOT.RDataFrame("Events", input_file)  # Replace 'tree_name' with the name of the tree in your ROOT file
