...
def GetEstimateSRFile_GJet(dataERA) -> EstimateSRFiles:
    if dataERA == '2022EE':
        return EstimateSRFiles(
                '/home/ltsai/ReceivedFile/GJet/latestsample/2022EE_MiniAODv12/stage2/stage2_GJetDataSignalRegion.root',
                '/home/ltsai/ReceivedFile/GJet/latestsample/2022EE_MiniAODv12/stage2/stage2_GJetDataDataSideband.root',
                '/home/ltsai/ReceivedFile/GJet/latestsample/2022EE_MiniAODv12/stage2/stage2_GJetMCGJetMadgraph.root',
                '',
    ...
    raise NotImplementedError()
def GetEstimateSRFile_GJetPythiaFlat(dataERA):
    if dataERA == '2022EE':
        return '/home/ltsai/ReceivedFile/GJet/latestsample/2022EE_MiniAODv12/stage2/stage2_GJetPythiaFlat.root'
def GetEstimateSRFile_GJet(dataERA) -> EstimateSRFiles:
    if dataERA == '2022EE':
        return EstimateSRFiles(
                '/home/ltsai/cms3/processedFile/2022EE_GJet/stage2_GJetDataSignalRegion.root',
