...
//  normWgt = 1.0*lumi*1000*7.351e+03*1.000000/4.0377335e+11;
  ...
  fout = new TFile("mytesting_gjetpythia.root", "RECREATE");
  normWgt = 1.0;
  isSignal = true;
}
...
#define MAX_GENJET 80
   ...
   TH1D *b_PhoPt            = new TH1D( "b_Pho_pt","Pho_pt", 75,210,1710);
   TH1D *b_PNetB            = new TH1D( "b_PNetB"          ,"PNetB"           , 100, 0.,1.);
   TH1D *b_PNetCvsB         = new TH1D( "b_PNetCvsB"       ,"PNetCvsB"        , 100, 0.,1.);
   TH1D *b_PNetCvsL         = new TH1D( "b_PNetCvsL"       ,"PNetCvsL"        , 100, 0.,1.);
   TH1D *b_PNetQvsG         = new TH1D( "b_PNetQvsG"       ,"PNetQvsG"        , 100, 0.,1.);
   TH1D *b_ParTB            = new TH1D( "b_ParTB"          ,"ParTB"           , 100, 0.,1.);
   TH1D *b_ParTCvsB         = new TH1D( "b_ParTCvsB"       ,"ParTCvsB"        , 100, 0.,1.);
   TH1D *b_ParTCvsL         = new TH1D( "b_ParTCvsL"       ,"ParTCvsL"        , 100, 0.,1.);
   TH1D *b_ParTQvsG         = new TH1D( "b_ParTQvsG"       ,"ParTQvsG"        , 100, 0.,1.);
   TH1D *b_DeepFlavourB     = new TH1D( "b_DeepFlavourB"   ,"DeepFlavourB"    , 100, 0.,1.);
   TH1D *b_DeepFlavourCvsB  = new TH1D( "b_DeepFlavourCvsB","DeepFlavourCvsB" , 100, 0.,1.);
   TH1D *b_DeepFlavourCvsL  = new TH1D( "b_DeepFlavourCvsL","DeepFlavourCvsL" , 100, 0.,1.);
   TH1D *b_DeepFlavourQvsG  = new TH1D( "b_DeepFlavourQvsG","DeepFlavourQvsG" , 100, 0.,1.);
   TH1D *b_PhoEta           = new TH1D( "b_PhoEta","", 100, -4., 4.);
   TH1D *b_PhoPhi           = new TH1D( "b_PhoPhi","", 100, -4., 4.);
   ...
   TH1D *e_PhoPt            = new TH1D("e_Pho_pt","Pho_pt", 75,210,1710);
   TH1D *e_PNetB            = new TH1D( "e_PNetB"          ,"PNetB"           , 100, 0.,1.);
   TH1D *e_PNetCvsB         = new TH1D( "e_PNetCvsB"       ,"PNetCvsB"        , 100, 0.,1.);
   TH1D *e_PNetCvsL         = new TH1D( "e_PNetCvsL"       ,"PNetCvsL"        , 100, 0.,1.);
   TH1D *e_PNetQvsG         = new TH1D( "e_PNetQvsG"       ,"PNetQvsG"        , 100, 0.,1.);
   TH1D *e_ParTB            = new TH1D( "e_ParTB"          ,"ParTB"           , 100, 0.,1.);
   TH1D *e_ParTCvsB         = new TH1D( "e_ParTCvsB"       ,"ParTCvsB"        , 100, 0.,1.);
   TH1D *e_ParTCvsL         = new TH1D( "e_ParTCvsL"       ,"ParTCvsL"        , 100, 0.,1.);
   TH1D *e_ParTQvsG         = new TH1D( "e_ParTQvsG"       ,"ParTQvsG"        , 100, 0.,1.);
   TH1D *e_DeepFlavourB     = new TH1D( "e_DeepFlavourB"   ,"DeepFlavourB"    , 100, 0.,1.);
   TH1D *e_DeepFlavourCvsB  = new TH1D( "e_DeepFlavourCvsB","DeepFlavourCvsB" , 100, 0.,1.);
   TH1D *e_DeepFlavourCvsL  = new TH1D( "e_DeepFlavourCvsL","DeepFlavourCvsL" , 100, 0.,1.);
   TH1D *e_DeepFlavourQvsG  = new TH1D( "e_DeepFlavourQvsG","DeepFlavourQvsG" , 100, 0.,1.);
   TH1D *e_PhoEta           = new TH1D( "e_PhoEta","", 100, -4., 4.);
   TH1D *e_PhoPhi           = new TH1D( "e_PhoPhi","", 100, -4., 4.);
...
//std::cout<<"start looping\n";
  ...
  for(iEvent = 0; iEvent< nEntries; ++iEvent){
    ...
    vector<double> SS_var_photon_BDT;
    vector<double> SS_var_photon_BDT_no_calib;
    ...
    {
      //if(HLT_Photon200==0) continue; // should MC passing this? asdf
      if ( isData && HLT_Photon200==0 ) continue;
      ...
      bool in_signalregion_or_data_sideband = true;
      if (!isDataSideband )
      {
          if(abs(Photon_eta[ij])<1.4442 && (Photon_pfChargedIsoPFPV[ij]>1.7 || Photon_sieie[ij]>0.015)) in_signalregion_or_data_sideband = false;
          if(abs(Photon_eta[ij])>1.566  && (Photon_pfChargedIsoPFPV[ij]>1.5 || Photon_sieie[ij]>0.04 )) in_signalregion_or_data_sideband = false;
      }
      else 
      {
          if(abs(Photon_eta[ij])<1.4442 && (Photon_pfChargedIsoPFPV[ij]<7 || Photon_sieie[ij]>0.015  )) in_signalregion_or_data_sideband = false;
          if(abs(Photon_eta[ij])>1.566  && (Photon_pfChargedIsoPFPV[ij]<7 || Photon_sieie[ij]>0.04   )) in_signalregion_or_data_sideband = false;
      }

      if(Photon_pfChargedIsoWorstVtx[ij]>10) continue;
      if(Photon_pfChargedIsoPFPV[ij]>10) continue;
      if(Photon_hoe[ij]>0.05) continue;
      if(abs(Photon_eta[ij])<1.44&&Photon_sieie[ij]>0.015) continue;
      if(abs(Photon_eta[ij])>1.566&&Photon_sieie[ij]>0.04) continue;
...
//      std::cout<<"pass all pho selections\n";
	//cout<<Photon_pt_nom<<"	"<<Photon_pt[ij]<<endl;
      ...
      if(isData==true || isOther==true){
          ...
          if(abs(Photon_eta[ij])<1.44){SS_var_photon_BDT.push_back(reader_barrel->EvaluateMVA("BDT"));}
          else{SS_var_photon_BDT.push_back(reader_endcap->EvaluateMVA("BDT"));}
          SS_var_photon_BDT_no_calib.push_back(0);
          SelPhotonALL.push_back(recoPho);
          SelPhotonIdxALL.push_back(ij);

          if ( in_signalregion_or_data_sideband )
          {
          ...
          MyPhotonMVA_MC_no_calib.push_back(0); // record nothing
      ...
      // not calibrated MVA calculation
          photon_esEffSigmaRR = Photon_esEffSigmaRR[ij];
          photon_energyRaw = Photon_energyRaw[ij];
          photon_esEnergyOverRawE = Photon_esEnergyOverRawE[ij];
          photon_etaWidth = Photon_etaWidth[ij];
          ...
          if(abs(Photon_eta[ij])<1.44){SS_var_photon_BDT_no_calib.push_back(reader_barrel->EvaluateMVA("BDT"));}
          else{SS_var_photon_BDT_no_calib.push_back(reader_endcap->EvaluateMVA("BDT"));}
          if ( in_signalregion_or_data_sideband )
          {
          if(abs(Photon_eta[ij])<1.44){MyPhotonMVA_MC_no_calib.push_back(reader_barrel->EvaluateMVA("BDT"));}
          else{MyPhotonMVA_MC_no_calib.push_back(reader_endcap->EvaluateMVA("BDT"));}
          }
    ...
    if(isQCD == true && nGenIsolatedPhoton <1){
          ...
          MyPhotonMVA_MC_no_calib.push_back(0);
    ...
    } // end of isQCD without nGenIsolatedPhoton
   ...
   if(isQCD == true && nGenIsolatedPhoton>0){
    ...
    } // end of isQCD with nGenIsolatedPhoton
...
//  std::cout<<"Passing SelJet size\n";
  ...
  if ( fill_histo )
  {
    ...
    {
      b_mva->Fill(SS_var_photon_BDT[0], evt_weight);
      ...
      b_HoverE           ->Fill( SS_var_photon_hoe[0],  evt_weight); 
      b_sieie            ->Fill( SS_var_photon_sieie[0], evt_weight); 
      b_sieip            ->Fill( SS_var_photon_sieip[0], evt_weight); 
      ...
      b_r9               ->Fill( SS_var_photon_r9[0], evt_weight); 
      b_s4               ->Fill( SS_var_photon_s4[0], evt_weight); 
      b_phiWidth         ->Fill( SS_var_photon_phiWidth[0], evt_weight); 
      b_etaWidth         ->Fill( SS_var_photon_etaWidth[0], evt_weight); 
      b_esEnergyOverRawE ->Fill( SS_var_photon_esEnergyOverRawE[0], evt_weight); 
      b_energyRaw        ->Fill( SS_var_photon_energyRaw[0], evt_weight); 
      b_esEffSigmaRR     ->Fill( SS_var_photon_esEffSigmaRR[0], evt_weight); 

      if ( isSignal)
      {
        borig_mva              ->Fill( SS_var_photon_BDT_no_calib[0], evt_weight); 
        borig_HoverE           ->Fill( Photon_hoe             [ SelPhotonIdxALL[0] ], evt_weight); 
        borig_sieie            ->Fill( Photon_sieie           [ SelPhotonIdxALL[0] ], evt_weight); 
        borig_sieip            ->Fill( Photon_sieip           [ SelPhotonIdxALL[0] ], evt_weight); 
        borig_r9               ->Fill( Photon_r9              [ SelPhotonIdxALL[0] ], evt_weight); 
        borig_s4               ->Fill( Photon_s4              [ SelPhotonIdxALL[0] ], evt_weight); 
        borig_phiWidth         ->Fill( Photon_phiWidth        [ SelPhotonIdxALL[0] ], evt_weight); 
        borig_etaWidth         ->Fill( Photon_etaWidth        [ SelPhotonIdxALL[0] ], evt_weight); 
        borig_esEnergyOverRawE ->Fill( Photon_esEnergyOverRawE[ SelPhotonIdxALL[0] ], evt_weight); 
        borig_energyRaw        ->Fill( Photon_energyRaw       [ SelPhotonIdxALL[0] ], evt_weight); 
        borig_esEffSigmaRR     ->Fill( Photon_esEffSigmaRR    [ SelPhotonIdxALL[0] ], evt_weight); 
      }
    }
    else // endcap
    {
      e_mva->Fill(SS_var_photon_BDT[0] , evt_weight);
      ...
      e_HoverE           ->Fill( SS_var_photon_hoe[0],  evt_weight); 
      e_sieie            ->Fill( SS_var_photon_sieie[0], evt_weight); 
      e_sieip            ->Fill( SS_var_photon_sieip[0], evt_weight); 
      ...
      e_r9               ->Fill( SS_var_photon_r9[0], evt_weight); 
      e_s4               ->Fill( SS_var_photon_s4[0], evt_weight); 
      e_phiWidth         ->Fill( SS_var_photon_phiWidth[0], evt_weight); 
      e_etaWidth         ->Fill( SS_var_photon_etaWidth[0], evt_weight); 
      e_esEnergyOverRawE ->Fill( SS_var_photon_esEnergyOverRawE[0], evt_weight); 
      e_energyRaw        ->Fill( SS_var_photon_energyRaw[0], evt_weight); 
      e_esEffSigmaRR     ->Fill( SS_var_photon_esEffSigmaRR[0], evt_weight); 

      if ( isSignal)
      {
        eorig_mva              ->Fill( SS_var_photon_BDT_no_calib[0], evt_weight); 
        eorig_HoverE           ->Fill( Photon_hoe             [ SelPhotonIdxALL[0] ], evt_weight); 
        eorig_sieie            ->Fill( Photon_sieie           [ SelPhotonIdxALL[0] ], evt_weight); 
        eorig_sieip            ->Fill( Photon_sieip           [ SelPhotonIdxALL[0] ], evt_weight); 
        eorig_r9               ->Fill( Photon_r9              [ SelPhotonIdxALL[0] ], evt_weight); 
        eorig_s4               ->Fill( Photon_s4              [ SelPhotonIdxALL[0] ], evt_weight); 
        eorig_phiWidth         ->Fill( Photon_phiWidth        [ SelPhotonIdxALL[0] ], evt_weight); 
        eorig_etaWidth         ->Fill( Photon_etaWidth        [ SelPhotonIdxALL[0] ], evt_weight); 
        eorig_esEnergyOverRawE ->Fill( Photon_esEnergyOverRawE[ SelPhotonIdxALL[0] ], evt_weight); 
        eorig_energyRaw        ->Fill( Photon_energyRaw       [ SelPhotonIdxALL[0] ], evt_weight); 
        eorig_esEffSigmaRR     ->Fill( Photon_esEffSigmaRR    [ SelPhotonIdxALL[0] ], evt_weight); 
      }
    }
  } // end of fill_histo

  
  // sel photon is filtered by in_signalregion_or_data_sideband
  ...
  photonMVAorig = MyPhotonMVA_MC_no_calib[0];
  ...
  isHadFlvr_L = isData ? false : GenJet_hadronFlavour[ Jet_genJetIdx[SelJetIdx[0]] ]==0; //asdf
...
//  std::cout<<"Filling something end\n";
  tree->Fill();
  ...
  // // select signal region or data sideband at tree only
  //  int phoidx = SelPhotonIdx[0];
  // if (!isDataSideband )
  // {
  //   if(abs(Photon_eta[phoidx])<1.44 &&Photon_pfChargedIsoPFPV[phoidx]>1.7) continue;
  //   if(abs(Photon_eta[phoidx])>1.566&&Photon_pfChargedIsoPFPV[phoidx]>1.5) continue;
  // }
  // else
  // {
  //   if(abs(Photon_eta[phoidx])<1.44 && (Photon_pfChargedIsoPFPV[phoidx]<7 || Photon_pfChargedIsoPFPV[phoidx]>20)) continue;
  //   if(abs(Photon_eta[phoidx])>1.566&& (Photon_pfChargedIsoPFPV[phoidx]<7 || Photon_pfChargedIsoPFPV[phoidx]>20)) continue;
  // }
  // tree->Fill();
}
